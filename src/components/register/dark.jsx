...
export default () => {
  return (
    ...
    <Helmet>
    <meta charSet="utf-8" />
        <title>FCDB Register Page</title>
                  ...
                  <div className="form-form-wrap">
                      <div className="form-container">
                          <div className="form-content">
                              ...
                              <p className="signup-link register">Already have an account? <Link to="/login">Log in</Link></p>
                              <form className="text-left">
                                  <div className="form">
                                      ...
                                      <div id="email-field" className="field-wrapper input">
                                          ...
                                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-at-sign register"><circle cx="12" cy="12" r="4"></circle><path d="M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-3.92 7.94"></path></svg>
                                          <input id="email" name="email" type="text" value="" className="form-control" placeholder="Email"/>
                                      </div>

                                      <div id="password-field" className="field-wrapper input mb-2">
                                          <div className="d-flex justify-content-between">
                                              <label for="password">PASSWORD</label>
                                              <Link to="recoverypassword" className="forgot-pass-link">Forgot Password?</Link>
                                          </div>
                                      ...
                                      <div className="d-sm-flex justify-content-between">
                                          <div className="field-wrapper">
                                              <button type="submit" className="btn btn-primary" value="">Get Started!</button>
                                          </div>
                                      </div>
