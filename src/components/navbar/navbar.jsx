    ...
    <header className="header navbar navbar-expand-sm">
        ...
        <ul className="navbar-item theme-brand flex-row  text-center">
            ...
            <li className="nav-item theme-text">
                <a href="index-2.html" className="nav-link"> Grow Kandan </a>
            </li>
        </ul>
        ...
        <ul className="navbar-item flex-row ml-md-auto">
            ...
            <li className="nav-item dropdown language-dropdown">
                <a href="javascript:void(0);" className="nav-link dropdown-toggle" id="language-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img src="assets/img/ng.png" className="flag-width" alt="flag"/>
                </a>
                    ...
                    <div className="">
                            ...
                            <div className="">
                                ...
                                <div className="media">
                                    <div className="user-img">
                                        <img className="usr-img rounded-circle" src="assets/img/profile-11.jpg" alt="profile"/>
                                    </div>
                        ...
                        <a className="dropdown-item">
                            <div className="">
                                ...
                                <div className="media">
                                    <div className="user-img">
                                        <img className="usr-img rounded-circle" src="assets/img/profile-16.jpg" alt="profile"/>
                                    </div>
                                    <div className="media-body">
                                        <div className="">
                        ...
                        <a className="dropdown-item">
                            <div className="">
                                ...
                                <div className="media">
                                    <div className="user-img">
                                        <img className="usr-img rounded-circle" src="assets/img/profile-34.jpg" alt="profile"/>
                                    </div>
                                    <div className="media-body">
                                        <div className="">
                    ...
                    <div className="notification-scroll">
                        ...
                        <div className="dropdown-item">
                            <div className="media">
                                ...
                                <div className="media-body">
                                    <div className="notification-para"><span className="user-name">Shaun Park</span> likes your photo.</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="dropdown-item">
                            <div className="media">
                                ...
                                <div className="media-body">
                                    <div className="notification-para"><span className="user-name">Kelly Young</span> shared your post</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="dropdown-item">
                            <div className="media">
                                ...
                                <div className="media-body">
                                    <div className="notification-para"><span className="user-name">Kelly Young</span> mentioned you in comment.</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <li className="nav-item dropdown user-profile-dropdown">
                ...
                <div className="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                    <div className="">
                        ...
                        <div className="dropdown-item">
                            <a href="apps_mailbox.html"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-inbox"><polyline points="22 12 16 12 14 15 10 15 8 12 2 12"></polyline><path d="M5.45 5.11L2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"></path></svg> Inbox</a>
                        </div>
                        <div className="dropdown-item">
                            <a href="auth_lockscreen.html"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-lock"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg> Lock Screen</a>
                        </div>
                        <div className="dropdown-item">
                            <Link to='/login'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-log-out"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg> Sign Out</Link>
                        </div>
                    </div>
                </div>
            </li>
