      ...
      {profile ?
        <div className="col-12" id="users-container">
          <div className="users-section-right shared">
            ...
            {this.state.userTab.toLowerCase() === "files"               ? <UserFiles active="1" files={null} uid={this.state.uid} refresh={() => this.refreshTab("Files")} load={() => this.setState({showLoader: !this.state.showLoader})} />         : null}
