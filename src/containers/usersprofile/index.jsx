      ...
      {profile ?
        <div className="col-12" id="users-container">
          <div className="users-section-right shared">
            ...
            {this.state.userTab.toLowerCase() === "emails"              ? <UserEmails active="1" profile={profile} uid={this.state.uid} refresh={() => this.refreshTab("Emails")} load={() => this.setState({showLoader: !this.state.showLoader})} />        : null}
